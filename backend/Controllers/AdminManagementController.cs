...
public class AdminManagementController : ControllerBase
{
    ...
    public async Task<IActionResult> CreateAdmin(CreateAdminDto dto)
    {
        ...
        // =====================================================
        // CHECK ADMIN ALREADY EXISTS FOR THIS HOSPITAL
        // =====================================================
        ...
        if (adminExists)
        {
            return BadRequest(new
            {
                message = "An Admin already exists for this clinic."
            });
        }
    ...
    public async Task<IActionResult> UpdateAdmin(int id, CreateAdminDto dto)
    {
        ...
        // =====================================================
        // PREVENT MOVING ADMIN TO A CLINIC THAT ALREADY HAS ADMIN
        // =====================================================

        var anotherAdmin = await _context.Users.AnyAsync(x =>
            x.Role == "Admin" &&
            x.HospitalId == hospitalId &&
            x.Id != id);
        ...
        if (anotherAdmin)
        {
            return BadRequest(new
            {
                message = "This clinic already has an Admin."
            });
        }
